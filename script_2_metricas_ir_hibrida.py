...
ARCHIVO_RESULTADOS = 'resultados_hibrida.json'
ARCHIVO_MACROS = 'dataset_test.json'
ARCHIVO_SALIDA_JSON = 'metricas_ir_hibrida.json'
ARCHIVO_SALIDA_EXCEL = 'metricas_ir_hibrida_resumen.xlsx'
...
RETRIEVALS_EVALUADOS = ['hibrida_generalista', 'hibrida_medico', 'hibrida_experto']
...
def main():
    ...
    resultados_filtrados = [
        ...
        and r['retrieval'] in RETRIEVALS_EVALUADOS
    ]
